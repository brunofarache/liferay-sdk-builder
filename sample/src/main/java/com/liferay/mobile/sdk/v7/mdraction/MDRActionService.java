...
public interface MDRActionService {
  ...
  @Path("/add-action")
  Call<JSONObject> addAction(@Param(name = "ruleGroupInstanceId") long ruleGroupInstanceId, @Param(name = "nameMap") JSONObject nameMap, @Param(name = "descriptionMap") JSONObject descriptionMap, @Param(name = "type") String type, @Param(name = "typeSettingsProperties") JSONObject typeSettingsProperties, @Param(name = "serviceContext", className = "com.liferay.portal.kernel.service.ServiceContext") JSONObject serviceContext);
  ...
  @Path("/update-action")
  Call<JSONObject> updateAction(@Param(name = "actionId") long actionId, @Param(name = "nameMap") JSONObject nameMap, @Param(name = "descriptionMap") JSONObject descriptionMap, @Param(name = "type") String type, @Param(name = "typeSettingsProperties") JSONObject typeSettingsProperties, @Param(name = "serviceContext", className = "com.liferay.portal.kernel.service.ServiceContext") JSONObject serviceContext);
}
