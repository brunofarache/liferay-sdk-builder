...
public interface JournalArticleService {
  ...
  @Path("/get-articles-by-structure-id")
  Call<JSONArray> getArticlesByStructureId(@Param(name = "groupId") long groupId, @Param(name = "ddmStructureKey") String ddmStructureKey, @Param(name = "status") int status, @Param(name = "start") int start, @Param(name = "end") int end, @Param(name = "obc", className = "com.liferay.portal.kernel.util.OrderByComparator") JSONObject obc);
  ...
  @Path("/get-group-articles")
  Call<JSONArray> getGroupArticles(@Param(name = "groupId") long groupId, @Param(name = "userId") long userId, @Param(name = "rootFolderId") long rootFolderId, @Param(name = "status") int status, @Param(name = "includeOwner") boolean includeOwner, @Param(name = "start") int start, @Param(name = "end") int end, @Param(name = "orderByComparator", className = "com.liferay.portal.kernel.util.OrderByComparator") JSONObject orderByComparator);
  ...
  @Path("/search")
  Call<JSONArray> search(@Param(name = "companyId") long companyId, @Param(name = "groupId") long groupId, @Param(name = "folderIds") JSONArray folderIds, @Param(name = "classNameId") long classNameId, @Param(name = "articleId") String articleId, @Param(name = "version") double version, @Param(name = "title") String title, @Param(name = "description") String description, @Param(name = "content") String content, @Param(name = "ddmStructureKeys") JSONArray ddmStructureKeys, @Param(name = "ddmTemplateKeys") JSONArray ddmTemplateKeys, @Param(name = "displayDateGT") long displayDateGT, @Param(name = "displayDateLT") long displayDateLT, @Param(name = "status") int status, @Param(name = "reviewDate") long reviewDate, @Param(name = "andOperator") boolean andOperator, @Param(name = "start") int start, @Param(name = "end") int end, @Param(name = "obc", className = "com.liferay.portal.kernel.util.OrderByComparator") JSONObject obc);
