...
- (NSArray *)getTemplateVersionsWithTemplateId:(long long)templateId start:(int)start end:(int)end orderByComparator:(NSDictionary *)orderByComparator error:(NSError **)error;
