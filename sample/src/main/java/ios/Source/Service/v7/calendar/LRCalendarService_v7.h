...
- (NSArray *)searchWithCompanyId:(long long)companyId groupIds:(NSArray *)groupIds calendarResourceIds:(NSArray *)calendarResourceIds keywords:(NSString *)keywords andOperator:(BOOL)andOperator start:(int)start end:(int)end orderByComparator:(NSDictionary *)orderByComparator error:(NSError **)error;
- (NSArray *)searchWithCompanyId:(long long)companyId groupIds:(NSArray *)groupIds calendarResourceIds:(NSArray *)calendarResourceIds keywords:(NSString *)keywords andOperator:(BOOL)andOperator start:(int)start end:(int)end orderByComparator:(NSDictionary *)orderByComparator actionId:(NSString *)actionId error:(NSError **)error;
- (NSArray *)searchWithCompanyId:(long long)companyId groupIds:(NSArray *)groupIds calendarResourceIds:(NSArray *)calendarResourceIds name:(NSString *)name description:(NSString *)description andOperator:(BOOL)andOperator start:(int)start end:(int)end orderByComparator:(NSDictionary *)orderByComparator error:(NSError **)error;
...
- (NSDictionary *)updateCalendarWithCalendarId:(long long)calendarId nameMap:(NSDictionary *)nameMap descriptionMap:(NSDictionary *)descriptionMap color:(int)color serviceContext:(NSDictionary *)serviceContext error:(NSError **)error;
...
- (NSDictionary *)updateColorWithCalendarId:(long long)calendarId color:(int)color serviceContext:(NSDictionary *)serviceContext error:(NSError **)error;
