...
- (NSString *)getCalendarBookingsRSSWithCalendarId:(long long)calendarId startTime:(long long)startTime endTime:(long long)endTime max:(int)max type:(NSString *)type version:(double)version displayStyle:(NSString *)displayStyle themeDisplay:(NSDictionary *)themeDisplay error:(NSError **)error {
	NSMutableDictionary *_params = [NSMutableDictionary dictionaryWithDictionary:@{
		@"calendarId": @(calendarId),
		@"startTime": @(startTime),
		@"endTime": @(endTime),
...
- (void)invokeTransitionWithCalendarBookingId:(long long)calendarBookingId status:(int)status serviceContext:(NSDictionary *)serviceContext error:(NSError **)error {
	NSMutableDictionary *_params = [NSMutableDictionary dictionaryWithDictionary:@{
		@"calendarBookingId": @(calendarBookingId),
		@"status": @(status),
		@"serviceContext": [self checkNull: serviceContext]
...
- (NSArray *)searchWithCompanyId:(long long)companyId groupIds:(NSArray *)groupIds calendarIds:(NSArray *)calendarIds calendarResourceIds:(NSArray *)calendarResourceIds parentCalendarBookingId:(long long)parentCalendarBookingId keywords:(NSString *)keywords startTime:(long long)startTime endTime:(long long)endTime recurring:(BOOL)recurring statuses:(NSArray *)statuses start:(int)start end:(int)end orderByComparator:(NSDictionary *)orderByComparator error:(NSError **)error {
	NSMutableDictionary *_params = [NSMutableDictionary dictionaryWithDictionary:@{
		@"companyId": @(companyId),
