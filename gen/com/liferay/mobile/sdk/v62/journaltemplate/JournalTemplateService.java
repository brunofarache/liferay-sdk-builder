...
public interface JournalTemplateService {
  @Path("/add-template")
  Call<JSONObject> addTemplate(@Param(name = "groupId") long groupId, @Param(name = "templateId") String templateId, @Param(name = "autoTemplateId") boolean autoTemplateId, @Param(name = "structureId") String structureId, @Param(name = "nameMap") Map nameMap, @Param(name = "descriptionMap") Map descriptionMap, @Param(name = "xsl") String xsl, @Param(name = "formatXsl") boolean formatXsl, @Param(name = "langType") String langType, @Param(name = "cacheable") boolean cacheable, @Param(name = "serviceContext", className = "com.liferay.portal.service.ServiceContext") JSONObject serviceContext);
  ...
  Call<JSONObject> updateTemplate(@Param(name = "groupId") long groupId, @Param(name = "templateId") String templateId, @Param(name = "structureId") String structureId, @Param(name = "nameMap") Map nameMap, @Param(name = "descriptionMap") Map descriptionMap, @Param(name = "xsl") String xsl, @Param(name = "formatXsl") boolean formatXsl, @Param(name = "langType") String langType, @Param(name = "cacheable") boolean cacheable, @Param(name = "serviceContext", className = "com.liferay.portal.service.ServiceContext") JSONObject serviceContext);
