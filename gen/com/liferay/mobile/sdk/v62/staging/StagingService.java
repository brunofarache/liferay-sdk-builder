...
public interface StagingService {
  ...
  Call<Response> publishStagingRequest(@Param(name = "stagingRequestId") long stagingRequestId, @Param(name = "privateLayout") boolean privateLayout, @Param(name = "parameterMap") Map parameterMap);
