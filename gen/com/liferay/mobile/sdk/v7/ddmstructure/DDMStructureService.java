...
public interface DDMStructureService {
  ...
  @Path("/copy-structure")
  Call<JSONObject> copyStructure(@Param(name = "structureId") long structureId, @Param(name = "nameMap") JSONObject nameMap, @Param(name = "descriptionMap") JSONObject descriptionMap, @Param(name = "serviceContext", className = "com.liferay.portal.kernel.service.ServiceContext") JSONObject serviceContext);
  ...
  Call<JSONObject> updateStructure(@Param(name = "structureId") long structureId, @Param(name = "parentStructureId") long parentStructureId, @Param(name = "nameMap") JSONObject nameMap, @Param(name = "descriptionMap") JSONObject descriptionMap, @Param(name = "definition") String definition, @Param(name = "serviceContext", className = "com.liferay.portal.kernel.service.ServiceContext") JSONObject serviceContext);

  @Path("/update-structure")
  Call<JSONObject> updateStructure(@Param(name = "structureId") long structureId, @Param(name = "parentStructureId") long parentStructureId, @Param(name = "nameMap") JSONObject nameMap, @Param(name = "descriptionMap") JSONObject descriptionMap, @Param(name = "ddmForm", className = "com.liferay.dynamic.data.mapping.model.DDMForm") JSONObject ddmForm, @Param(name = "ddmFormLayout", className = "com.liferay.dynamic.data.mapping.model.DDMFormLayout") JSONObject ddmFormLayout, @Param(name = "serviceContext", className = "com.liferay.portal.kernel.service.ServiceContext") JSONObject serviceContext);

  @Path("/update-structure")
  Call<JSONObject> updateStructure(@Param(name = "groupId") long groupId, @Param(name = "parentStructureId") long parentStructureId, @Param(name = "classNameId") long classNameId, @Param(name = "structureKey") String structureKey, @Param(name = "nameMap") JSONObject nameMap, @Param(name = "descriptionMap") JSONObject descriptionMap, @Param(name = "definition") String definition, @Param(name = "serviceContext", className = "com.liferay.portal.kernel.service.ServiceContext") JSONObject serviceContext);
