...
public interface DltrashService {
  ...
  Call<JSONObject> moveFileShortcutFromTrash(@Param(name = "fileShortcutId") long fileShortcutId, @Param(name = "newFolderId") long newFolderId, @Param(name = "serviceContext", className = "") JSONObject serviceContext);
