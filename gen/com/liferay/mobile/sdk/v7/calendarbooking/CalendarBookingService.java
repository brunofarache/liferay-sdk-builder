...
public interface CalendarBookingService {
  ...
  Call<JSONObject> addCalendarBooking(@Param(name = "calendarId") long calendarId, @Param(name = "childCalendarIds") JSONArray childCalendarIds, @Param(name = "parentCalendarBookingId") long parentCalendarBookingId, @Param(name = "titleMap", className = "map<string,string>") JSONObject titleMap, @Param(name = "descriptionMap", className = "map<string,string>") JSONObject descriptionMap, @Param(name = "location") String location, @Param(name = "startTime") long startTime, @Param(name = "endTime") long endTime, @Param(name = "allDay") boolean allDay, @Param(name = "recurrence") String recurrence, @Param(name = "firstReminder") long firstReminder, @Param(name = "firstReminderType") String firstReminderType, @Param(name = "secondReminder") long secondReminder, @Param(name = "secondReminderType") String secondReminderType, @Param(name = "serviceContext", className = "com.liferay.portal.kernel.service.ServiceContext") JSONObject serviceContext);

  @Path("/add-calendar-booking")
  Call<JSONObject> addCalendarBooking(@Param(name = "calendarId") long calendarId, @Param(name = "childCalendarIds") JSONArray childCalendarIds, @Param(name = "parentCalendarBookingId") long parentCalendarBookingId, @Param(name = "titleMap", className = "map<string,string>") JSONObject titleMap, @Param(name = "descriptionMap", className = "map<string,string>") JSONObject descriptionMap, @Param(name = "location") String location, @Param(name = "startTimeYear") int startTimeYear, @Param(name = "startTimeMonth") int startTimeMonth, @Param(name = "startTimeDay") int startTimeDay, @Param(name = "startTimeHour") int startTimeHour, @Param(name = "startTimeMinute") int startTimeMinute, @Param(name = "endTimeYear") int endTimeYear, @Param(name = "endTimeMonth") int endTimeMonth, @Param(name = "endTimeDay") int endTimeDay, @Param(name = "endTimeHour") int endTimeHour, @Param(name = "endTimeMinute") int endTimeMinute, @Param(name = "timeZoneId") String timeZoneId, @Param(name = "allDay") boolean allDay, @Param(name = "recurrence") String recurrence, @Param(name = "firstReminder") long firstReminder, @Param(name = "firstReminderType") String firstReminderType, @Param(name = "secondReminder") long secondReminder, @Param(name = "secondReminderType") String secondReminderType, @Param(name = "serviceContext", className = "com.liferay.portal.kernel.service.ServiceContext") JSONObject serviceContext);
  ...
  Call<JSONObject> updateCalendarBooking(@Param(name = "calendarBookingId") long calendarBookingId, @Param(name = "calendarId") long calendarId, @Param(name = "titleMap", className = "map<string,string>") JSONObject titleMap, @Param(name = "descriptionMap", className = "map<string,string>") JSONObject descriptionMap, @Param(name = "location") String location, @Param(name = "startTime") long startTime, @Param(name = "endTime") long endTime, @Param(name = "allDay") boolean allDay, @Param(name = "recurrence") String recurrence, @Param(name = "firstReminder") long firstReminder, @Param(name = "firstReminderType") String firstReminderType, @Param(name = "secondReminder") long secondReminder, @Param(name = "secondReminderType") String secondReminderType, @Param(name = "serviceContext", className = "com.liferay.portal.kernel.service.ServiceContext") JSONObject serviceContext);

  @Path("/update-calendar-booking")
  Call<JSONObject> updateCalendarBooking(@Param(name = "calendarBookingId") long calendarBookingId, @Param(name = "calendarId") long calendarId, @Param(name = "childCalendarIds") JSONArray childCalendarIds, @Param(name = "titleMap", className = "map<string,string>") JSONObject titleMap, @Param(name = "descriptionMap", className = "map<string,string>") JSONObject descriptionMap, @Param(name = "location") String location, @Param(name = "startTime") long startTime, @Param(name = "endTime") long endTime, @Param(name = "allDay") boolean allDay, @Param(name = "recurrence") String recurrence, @Param(name = "firstReminder") long firstReminder, @Param(name = "firstReminderType") String firstReminderType, @Param(name = "secondReminder") long secondReminder, @Param(name = "secondReminderType") String secondReminderType, @Param(name = "serviceContext", className = "com.liferay.portal.kernel.service.ServiceContext") JSONObject serviceContext);

  @Path("/update-calendar-booking-instance")
  Call<JSONObject> updateCalendarBookingInstance(@Param(name = "calendarBookingId") long calendarBookingId, @Param(name = "instanceIndex") int instanceIndex, @Param(name = "calendarId") long calendarId, @Param(name = "titleMap", className = "map<string,string>") JSONObject titleMap, @Param(name = "descriptionMap", className = "map<string,string>") JSONObject descriptionMap, @Param(name = "location") String location, @Param(name = "startTime") long startTime, @Param(name = "endTime") long endTime, @Param(name = "allDay") boolean allDay, @Param(name = "recurrence") String recurrence, @Param(name = "allFollowing") boolean allFollowing, @Param(name = "firstReminder") long firstReminder, @Param(name = "firstReminderType") String firstReminderType, @Param(name = "secondReminder") long secondReminder, @Param(name = "secondReminderType") String secondReminderType, @Param(name = "serviceContext", className = "com.liferay.portal.kernel.service.ServiceContext") JSONObject serviceContext);

  @Path("/update-calendar-booking-instance")
  Call<JSONObject> updateCalendarBookingInstance(@Param(name = "calendarBookingId") long calendarBookingId, @Param(name = "instanceIndex") int instanceIndex, @Param(name = "calendarId") long calendarId, @Param(name = "childCalendarIds") JSONArray childCalendarIds, @Param(name = "titleMap", className = "map<string,string>") JSONObject titleMap, @Param(name = "descriptionMap", className = "map<string,string>") JSONObject descriptionMap, @Param(name = "location") String location, @Param(name = "startTime") long startTime, @Param(name = "endTime") long endTime, @Param(name = "allDay") boolean allDay, @Param(name = "recurrence") String recurrence, @Param(name = "allFollowing") boolean allFollowing, @Param(name = "firstReminder") long firstReminder, @Param(name = "firstReminderType") String firstReminderType, @Param(name = "secondReminder") long secondReminder, @Param(name = "secondReminderType") String secondReminderType, @Param(name = "serviceContext", className = "com.liferay.portal.kernel.service.ServiceContext") JSONObject serviceContext);
