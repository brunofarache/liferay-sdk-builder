...
public interface UserService {
  ...
  Call<JSONObject> updateEmailAddress(@Param(name = "userId") long userId, @Param(name = "password") String password, @Param(name = "emailAddress1") String emailAddress1, @Param(name = "emailAddress2") String emailAddress2, @Param(name = "serviceContext", className = "") JSONObject serviceContext);
  ...
  Call<Response> unsetGroupUsers(@Param(name = "groupId") long groupId, @Param(name = "userIds") JSONArray userIds, @Param(name = "serviceContext", className = "") JSONObject serviceContext);

  @Path("/update-status")
  Call<JSONObject> updateStatus(@Param(name = "userId") long userId, @Param(name = "status") int status);

  @Path("/update-status")
  Call<JSONObject> updateStatus(@Param(name = "userId") long userId, @Param(name = "status") int status, @Param(name = "serviceContext", className = "") JSONObject serviceContext);

  @Path("/add-group-users")
  Call<Response> addGroupUsers(@Param(name = "groupId") long groupId, @Param(name = "userIds") JSONArray userIds, @Param(name = "serviceContext", className = "") JSONObject serviceContext);
  ...
  Call<JSONObject> updateIncompleteUser(@Param(name = "companyId") long companyId, @Param(name = "autoPassword") boolean autoPassword, @Param(name = "password1") String password1, @Param(name = "password2") String password2, @Param(name = "autoScreenName") boolean autoScreenName, @Param(name = "screenName") String screenName, @Param(name = "emailAddress") String emailAddress, @Param(name = "facebookId") long facebookId, @Param(name = "openId") String openId, @Param(name = "locale") String locale, @Param(name = "firstName") String firstName, @Param(name = "middleName") String middleName, @Param(name = "lastName") String lastName, @Param(name = "prefixId") long prefixId, @Param(name = "suffixId") long suffixId, @Param(name = "male") boolean male, @Param(name = "birthdayMonth") int birthdayMonth, @Param(name = "birthdayDay") int birthdayDay, @Param(name = "birthdayYear") int birthdayYear, @Param(name = "jobTitle") String jobTitle, @Param(name = "updateUserInformation") boolean updateUserInformation, @Param(name = "sendEmail") boolean sendEmail, @Param(name = "serviceContext", className = "") JSONObject serviceContext);

  @Path("/update-open-id")
  Call<JSONObject> updateOpenId(@Param(name = "userId") long userId, @Param(name = "openId") String openId);

  @Path("/update-organizations")
  Call<Response> updateOrganizations(@Param(name = "userId") long userId, @Param(name = "organizationIds") JSONArray organizationIds, @Param(name = "serviceContext", className = "") JSONObject serviceContext);
