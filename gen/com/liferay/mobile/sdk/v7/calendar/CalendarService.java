...
public interface CalendarService {
  ...
  Call<JSONObject> updateCalendar(@Param(name = "calendarId") long calendarId, @Param(name = "nameMap") JSONObject nameMap, @Param(name = "descriptionMap") JSONObject descriptionMap, @Param(name = "color") int color, @Param(name = "serviceContext", className = "com.liferay.portal.kernel.service.ServiceContext") JSONObject serviceContext);

  @Path("/update-calendar")
  Call<JSONObject> updateCalendar(@Param(name = "calendarId") long calendarId, @Param(name = "nameMap") JSONObject nameMap, @Param(name = "descriptionMap") JSONObject descriptionMap, @Param(name = "timeZoneId") String timeZoneId, @Param(name = "color") int color, @Param(name = "defaultCalendar") boolean defaultCalendar, @Param(name = "enableComments") boolean enableComments, @Param(name = "enableRatings") boolean enableRatings, @Param(name = "serviceContext", className = "com.liferay.portal.kernel.service.ServiceContext") JSONObject serviceContext);
