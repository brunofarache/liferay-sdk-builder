...
public interface AssetVocabularyService {
  ...
  @Path("/add-vocabulary")
  Call<JSONObject> addVocabulary(@Param(name = "groupId") long groupId, @Param(name = "title") String title, @Param(name = "titleMap") JSONObject titleMap, @Param(name = "descriptionMap") JSONObject descriptionMap, @Param(name = "settings") String settings, @Param(name = "serviceContext", className = "com.liferay.portal.kernel.service.ServiceContext") JSONObject serviceContext);
  ...
  Call<JSONObject> updateVocabulary(@Param(name = "vocabularyId") long vocabularyId, @Param(name = "title") String title, @Param(name = "titleMap") JSONObject titleMap, @Param(name = "descriptionMap") JSONObject descriptionMap, @Param(name = "settings") String settings, @Param(name = "serviceContext", className = "com.liferay.portal.kernel.service.ServiceContext") JSONObject serviceContext);
}
