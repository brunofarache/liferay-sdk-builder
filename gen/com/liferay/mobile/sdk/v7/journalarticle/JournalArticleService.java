...
public interface JournalArticleService {
  ...
  @Path("/delete-article")
  Call<Response> deleteArticle(@Param(name = "groupId") long groupId, @Param(name = "articleId") String articleId, @Param(name = "articleURL") String articleURL, @Param(name = "serviceContext", className = "com.liferay.portal.kernel.service.ServiceContext") JSONObject serviceContext);

  @Path("/delete-article")
  Call<Response> deleteArticle(@Param(name = "groupId") long groupId, @Param(name = "articleId") String articleId, @Param(name = "version") double version, @Param(name = "articleURL") String articleURL, @Param(name = "serviceContext", className = "com.liferay.portal.kernel.service.ServiceContext") JSONObject serviceContext);

  @Path("/expire-article")
  Call<Response> expireArticle(@Param(name = "groupId") long groupId, @Param(name = "articleId") String articleId, @Param(name = "articleURL") String articleURL, @Param(name = "serviceContext", className = "com.liferay.portal.kernel.service.ServiceContext") JSONObject serviceContext);

  @Path("/expire-article")
  Call<JSONObject> expireArticle(@Param(name = "groupId") long groupId, @Param(name = "articleId") String articleId, @Param(name = "version") double version, @Param(name = "articleURL") String articleURL, @Param(name = "serviceContext", className = "com.liferay.portal.kernel.service.ServiceContext") JSONObject serviceContext);
  ...
  Call<String> getArticleContent(@Param(name = "groupId") long groupId, @Param(name = "articleId") String articleId, @Param(name = "languageId") String languageId, @Param(name = "themeDisplay", className = "com.liferay.portal.kernel.theme.ThemeDisplay") JSONObject themeDisplay);

  @Path("/get-article-content")
  Call<String> getArticleContent(@Param(name = "groupId") long groupId, @Param(name = "articleId") String articleId, @Param(name = "languageId") String languageId, @Param(name = "portletRequestModel", className = "com.liferay.portal.kernel.portlet.PortletRequestModel") JSONObject portletRequestModel, @Param(name = "themeDisplay", className = "com.liferay.portal.kernel.theme.ThemeDisplay") JSONObject themeDisplay);

  @Path("/get-article-content")
  Call<String> getArticleContent(@Param(name = "groupId") long groupId, @Param(name = "articleId") String articleId, @Param(name = "version") double version, @Param(name = "languageId") String languageId, @Param(name = "themeDisplay", className = "com.liferay.portal.kernel.theme.ThemeDisplay") JSONObject themeDisplay);
  ...
  @Path("/get-articles")
  Call<JSONArray> getArticles(@Param(name = "groupId") long groupId, @Param(name = "folderId") long folderId, @Param(name = "start") int start, @Param(name = "end") int end, @Param(name = "obc", className = "com.liferay.portal.kernel.util.OrderByComparator<com.liferay.journal.model.JournalArticle>") JSONObject obc);

  @Path("/get-articles-by-article-id")
  Call<JSONArray> getArticlesByArticleId(@Param(name = "groupId") long groupId, @Param(name = "articleId") String articleId, @Param(name = "start") int start, @Param(name = "end") int end, @Param(name = "obc", className = "com.liferay.portal.kernel.util.OrderByComparator<com.liferay.journal.model.JournalArticle>") JSONObject obc);
  ...
  Call<JSONArray> getArticlesByStructureId(@Param(name = "groupId") long groupId, @Param(name = "ddmStructureKey") String ddmStructureKey, @Param(name = "start") int start, @Param(name = "end") int end, @Param(name = "obc", className = "com.liferay.portal.kernel.util.OrderByComparator<com.liferay.journal.model.JournalArticle>") JSONObject obc);

  @Path("/get-articles-by-structure-id")
  Call<JSONArray> getArticlesByStructureId(@Param(name = "groupId") long groupId, @Param(name = "ddmStructureKey") String ddmStructureKey, @Param(name = "status") int status, @Param(name = "start") int start, @Param(name = "end") int end, @Param(name = "obc", className = "com.liferay.portal.kernel.util.OrderByComparator<com.liferay.journal.model.JournalArticle>") JSONObject obc);
  ...
  Call<JSONArray> getGroupArticles(@Param(name = "groupId") long groupId, @Param(name = "userId") long userId, @Param(name = "rootFolderId") long rootFolderId, @Param(name = "start") int start, @Param(name = "end") int end, @Param(name = "orderByComparator", className = "com.liferay.portal.kernel.util.OrderByComparator<com.liferay.journal.model.JournalArticle>") JSONObject orderByComparator);

  @Path("/get-group-articles")
  Call<JSONArray> getGroupArticles(@Param(name = "groupId") long groupId, @Param(name = "userId") long userId, @Param(name = "rootFolderId") long rootFolderId, @Param(name = "status") int status, @Param(name = "start") int start, @Param(name = "end") int end, @Param(name = "orderByComparator", className = "com.liferay.portal.kernel.util.OrderByComparator<com.liferay.journal.model.JournalArticle>") JSONObject orderByComparator);

  @Path("/get-group-articles")
  Call<JSONArray> getGroupArticles(@Param(name = "groupId") long groupId, @Param(name = "userId") long userId, @Param(name = "rootFolderId") long rootFolderId, @Param(name = "status") int status, @Param(name = "includeOwner") boolean includeOwner, @Param(name = "start") int start, @Param(name = "end") int end, @Param(name = "orderByComparator", className = "com.liferay.portal.kernel.util.OrderByComparator<com.liferay.journal.model.JournalArticle>") JSONObject orderByComparator);
  ...
  @Path("/search")
  Call<JSONArray> search(@Param(name = "companyId") long companyId, @Param(name = "groupId") long groupId, @Param(name = "folderIds") JSONArray folderIds, @Param(name = "classNameId") long classNameId, @Param(name = "keywords") String keywords, @Param(name = "version") double version, @Param(name = "ddmStructureKey") String ddmStructureKey, @Param(name = "ddmTemplateKey") String ddmTemplateKey, @Param(name = "displayDateGT") long displayDateGT, @Param(name = "displayDateLT") long displayDateLT, @Param(name = "status") int status, @Param(name = "reviewDate") long reviewDate, @Param(name = "start") int start, @Param(name = "end") int end, @Param(name = "obc", className = "com.liferay.portal.kernel.util.OrderByComparator<com.liferay.journal.model.JournalArticle>") JSONObject obc);

  @Path("/search")
  Call<JSONArray> search(@Param(name = "companyId") long companyId, @Param(name = "groupId") long groupId, @Param(name = "folderIds") JSONArray folderIds, @Param(name = "classNameId") long classNameId, @Param(name = "articleId") String articleId, @Param(name = "version") double version, @Param(name = "title") String title, @Param(name = "description") String description, @Param(name = "content") String content, @Param(name = "ddmStructureKey") String ddmStructureKey, @Param(name = "ddmTemplateKey") String ddmTemplateKey, @Param(name = "displayDateGT") long displayDateGT, @Param(name = "displayDateLT") long displayDateLT, @Param(name = "status") int status, @Param(name = "reviewDate") long reviewDate, @Param(name = "andOperator") boolean andOperator, @Param(name = "start") int start, @Param(name = "end") int end, @Param(name = "obc", className = "com.liferay.portal.kernel.util.OrderByComparator<com.liferay.journal.model.JournalArticle>") JSONObject obc);

  @Path("/search")
  Call<JSONArray> search(@Param(name = "companyId") long companyId, @Param(name = "groupId") long groupId, @Param(name = "folderIds") JSONArray folderIds, @Param(name = "classNameId") long classNameId, @Param(name = "articleId") String articleId, @Param(name = "version") double version, @Param(name = "title") String title, @Param(name = "description") String description, @Param(name = "content") String content, @Param(name = "ddmStructureKeys") JSONArray ddmStructureKeys, @Param(name = "ddmTemplateKeys") JSONArray ddmTemplateKeys, @Param(name = "displayDateGT") long displayDateGT, @Param(name = "displayDateLT") long displayDateLT, @Param(name = "status") int status, @Param(name = "reviewDate") long reviewDate, @Param(name = "andOperator") boolean andOperator, @Param(name = "start") int start, @Param(name = "end") int end, @Param(name = "obc", className = "com.liferay.portal.kernel.util.OrderByComparator<com.liferay.journal.model.JournalArticle>") JSONObject obc);
  ...
  @Path("/update-article")
  Call<JSONObject> updateArticle(@Param(name = "groupId") long groupId, @Param(name = "folderId") long folderId, @Param(name = "articleId") String articleId, @Param(name = "version") double version, @Param(name = "content") String content, @Param(name = "serviceContext", className = "com.liferay.portal.kernel.service.ServiceContext") JSONObject serviceContext);

  @Path("/update-article")
  Call<JSONObject> updateArticle(@Param(name = "userId") long userId, @Param(name = "groupId") long groupId, @Param(name = "folderId") long folderId, @Param(name = "articleId") String articleId, @Param(name = "version") double version, @Param(name = "titleMap") JSONObject titleMap, @Param(name = "descriptionMap") JSONObject descriptionMap, @Param(name = "content") String content, @Param(name = "layoutUuid") String layoutUuid, @Param(name = "serviceContext", className = "com.liferay.portal.kernel.service.ServiceContext") JSONObject serviceContext);

  @Path(
      value = "/update-article",
      contentType = ContentType.MULTIPART
  )
  Call<JSONObject> updateArticle(@Param(name = "groupId") long groupId, @Param(name = "folderId") long folderId, @Param(name = "articleId") String articleId, @Param(name = "version") double version, @Param(name = "titleMap") JSONObject titleMap, @Param(name = "descriptionMap") JSONObject descriptionMap, @Param(name = "content") String content, @Param(name = "ddmStructureKey") String ddmStructureKey, @Param(name = "ddmTemplateKey") String ddmTemplateKey, @Param(name = "layoutUuid") String layoutUuid, @Param(name = "displayDateMonth") int displayDateMonth, @Param(name = "displayDateDay") int displayDateDay, @Param(name = "displayDateYear") int displayDateYear, @Param(name = "displayDateHour") int displayDateHour, @Param(name = "displayDateMinute") int displayDateMinute, @Param(name = "expirationDateMonth") int expirationDateMonth, @Param(name = "expirationDateDay") int expirationDateDay, @Param(name = "expirationDateYear") int expirationDateYear, @Param(name = "expirationDateHour") int expirationDateHour, @Param(name = "expirationDateMinute") int expirationDateMinute, @Param(name = "neverExpire") boolean neverExpire, @Param(name = "reviewDateMonth") int reviewDateMonth, @Param(name = "reviewDateDay") int reviewDateDay, @Param(name = "reviewDateYear") int reviewDateYear, @Param(name = "reviewDateHour") int reviewDateHour, @Param(name = "reviewDateMinute") int reviewDateMinute, @Param(name = "neverReview") boolean neverReview, @Param(name = "indexable") boolean indexable, @Param(name = "smallImage") boolean smallImage, @Param(name = "smallImageURL") String smallImageURL, @Param(name = "smallFile") UploadData smallFile, @Param(name = "images") JSONObject images, @Param(name = "articleURL") String articleURL, @Param(name = "serviceContext", className = "com.liferay.portal.kernel.service.ServiceContext") JSONObject serviceContext);

  @Path("/update-article-translation")
  Call<JSONObject> updateArticleTranslation(@Param(name = "groupId") long groupId, @Param(name = "articleId") String articleId, @Param(name = "version") double version, @Param(name = "locale") String locale, @Param(name = "title") String title, @Param(name = "description") String description, @Param(name = "content") String content, @Param(name = "images") JSONObject images, @Param(name = "serviceContext", className = "com.liferay.portal.kernel.service.ServiceContext") JSONObject serviceContext);
  ...
  @Path("/update-status")
  Call<JSONObject> updateStatus(@Param(name = "groupId") long groupId, @Param(name = "articleId") String articleId, @Param(name = "version") double version, @Param(name = "status") int status, @Param(name = "articleURL") String articleURL, @Param(name = "serviceContext", className = "com.liferay.portal.kernel.service.ServiceContext") JSONObject serviceContext);
}
