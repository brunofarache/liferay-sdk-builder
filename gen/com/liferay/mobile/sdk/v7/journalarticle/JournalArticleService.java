...
public interface JournalArticleService {
  ...
  @Path("/update-article")
  Call<JSONObject> updateArticle(@Param(name = "userId") long userId, @Param(name = "groupId") long groupId, @Param(name = "folderId") long folderId, @Param(name = "articleId") String articleId, @Param(name = "version") double version, @Param(name = "titleMap", className = "map<string,string>") JSONObject titleMap, @Param(name = "descriptionMap", className = "map<string,string>") JSONObject descriptionMap, @Param(name = "content") String content, @Param(name = "layoutUuid") String layoutUuid, @Param(name = "serviceContext", className = "com.liferay.portal.kernel.service.ServiceContext") JSONObject serviceContext);
  ...
  Call<JSONObject> updateArticleTranslation(@Param(name = "groupId") long groupId, @Param(name = "articleId") String articleId, @Param(name = "version") double version, @Param(name = "locale") String locale, @Param(name = "title") String title, @Param(name = "description") String description, @Param(name = "content") String content, @Param(name = "images", className = "map<string,byte[]>") JSONObject images, @Param(name = "serviceContext", className = "com.liferay.portal.kernel.service.ServiceContext") JSONObject serviceContext);
