package com.liferay.mobile.sdk.v7.resourceblock;
...
public interface ResourceBlockService {
  ...
  Call<Response> setIndividualScopePermissions(@Param(name = "companyId") long companyId, @Param(name = "groupId") long groupId, @Param(name = "name") String name, @Param(name = "primKey") long primKey, @Param(name = "roleIdsToActionIds", className = "map<long,string[]>") JSONObject roleIdsToActionIds);
