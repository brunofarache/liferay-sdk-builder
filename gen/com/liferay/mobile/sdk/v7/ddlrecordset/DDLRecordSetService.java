...
public interface DDLRecordSetService {
  ...
  @Path("/update-record-set")
  Call<JSONObject> updateRecordSet(@Param(name = "recordSetId") long recordSetId, @Param(name = "ddmStructureId") long ddmStructureId, @Param(name = "nameMap", className = "map<string,string>") JSONObject nameMap, @Param(name = "descriptionMap", className = "map<string,string>") JSONObject descriptionMap, @Param(name = "minDisplayRows") int minDisplayRows, @Param(name = "serviceContext", className = "com.liferay.portal.kernel.service.ServiceContext") JSONObject serviceContext);
