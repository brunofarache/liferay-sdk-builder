...
public interface RoleService {
  @Path("/add-role")
  Call<JSONObject> addRole(@Param(name = "className") String className, @Param(name = "classPK") long classPK, @Param(name = "name") String name, @Param(name = "titleMap", className = "map<string,string>") JSONObject titleMap, @Param(name = "descriptionMap", className = "map<string,string>") JSONObject descriptionMap, @Param(name = "type") int type, @Param(name = "subtype") String subtype, @Param(name = "serviceContext", className = "com.liferay.portal.kernel.service.ServiceContext") JSONObject serviceContext);
  ...
  @Path("/search")
  Call<JSONArray> search(@Param(name = "companyId") long companyId, @Param(name = "keywords") String keywords, @Param(name = "types") JSONArray types, @Param(name = "params", className = "map<string,map>") JSONObject params, @Param(name = "start") int start, @Param(name = "end") int end, @Param(name = "obc", className = "com.liferay.portal.kernel.util.OrderByComparator<com.liferay.portal.kernel.model.Role>") JSONObject obc);

  @Path("/search-count")
  Call<Integer> searchCount(@Param(name = "companyId") long companyId, @Param(name = "keywords") String keywords, @Param(name = "types") JSONArray types, @Param(name = "params", className = "map<string,map>") JSONObject params);

  @Path("/unset-user-roles")
  Call<Response> unsetUserRoles(@Param(name = "userId") long userId, @Param(name = "roleIds") JSONArray roleIds);

  @Path("/update-role")
  Call<JSONObject> updateRole(@Param(name = "roleId") long roleId, @Param(name = "name") String name, @Param(name = "titleMap", className = "map<string,string>") JSONObject titleMap, @Param(name = "descriptionMap", className = "map<string,string>") JSONObject descriptionMap, @Param(name = "subtype") String subtype, @Param(name = "serviceContext", className = "com.liferay.portal.kernel.service.ServiceContext") JSONObject serviceContext);
}
