...
public interface ResourcePermissionService {
  ...
  Call<Response> setIndividualResourcePermissions(@Param(name = "groupId") long groupId, @Param(name = "companyId") long companyId, @Param(name = "name") String name, @Param(name = "primKey") String primKey, @Param(name = "roleIdsToActionIds", className = "map<long,string[]>") JSONObject roleIdsToActionIds);
