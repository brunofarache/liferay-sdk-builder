package com.liferay.mobile.sdk.v7.company;
...
public interface CompanyService {
  ...
  @Path("/update-company")
  Call<JSONObject> updateCompany(@Param(name = "companyId") long companyId, @Param(name = "virtualHost") String virtualHost, @Param(name = "mx") String mx, @Param(name = "homeURL") String homeURL, @Param(name = "logo") boolean logo, @Param(name = "logoBytes") byte[] logoBytes, @Param(name = "name") String name, @Param(name = "legalName") String legalName, @Param(name = "legalId") String legalId, @Param(name = "legalType") String legalType, @Param(name = "sicCode") String sicCode, @Param(name = "tickerSymbol") String tickerSymbol, @Param(name = "industry") String industry, @Param(name = "type") String type, @Param(name = "size") String size);
