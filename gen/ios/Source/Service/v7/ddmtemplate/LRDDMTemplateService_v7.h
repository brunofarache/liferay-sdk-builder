...
- (NSDictionary *)addTemplateWithGroupId:(long long)groupId classNameId:(long long)classNameId classPK:(long long)classPK resourceClassNameId:(long long)resourceClassNameId nameMap:(NSDictionary *)nameMap descriptionMap:(NSDictionary *)descriptionMap type:(NSString *)type mode:(NSString *)mode language:(NSString *)language script:(NSString *)script serviceContext:(NSDictionary *)serviceContext error:(NSError **)error;
...
- (NSArray *)copyTemplatesWithClassNameId:(long long)classNameId oldClassPK:(long long)oldClassPK resourceClassNameId:(long long)resourceClassNameId newClassPK:(long long)newClassPK type:(NSString *)type serviceContext:(NSDictionary *)serviceContext error:(NSError **)error;
...
- (NSArray *)getTemplatesByStructureClassNameIdWithGroupId:(long long)groupId structureClassNameId:(long long)structureClassNameId status:(int)status start:(int)start end:(int)end orderByComparator:(NSDictionary *)orderByComparator error:(NSError **)error;
...
- (void)revertTemplateWithTemplateId:(long long)templateId version:(NSString *)version serviceContext:(NSDictionary *)serviceContext error:(NSError **)error;
- (NSArray *)searchWithCompanyId:(long long)companyId groupIds:(NSArray *)groupIds classNameIds:(NSArray *)classNameIds classPKs:(NSArray *)classPKs resourceClassNameId:(long long)resourceClassNameId keywords:(NSString *)keywords type:(NSString *)type mode:(NSString *)mode status:(int)status start:(int)start end:(int)end orderByComparator:(NSDictionary *)orderByComparator error:(NSError **)error;
- (NSArray *)searchWithCompanyId:(long long)companyId groupId:(long long)groupId classNameId:(long long)classNameId classPK:(long long)classPK resourceClassNameId:(long long)resourceClassNameId keywords:(NSString *)keywords type:(NSString *)type mode:(NSString *)mode status:(int)status start:(int)start end:(int)end orderByComparator:(NSDictionary *)orderByComparator error:(NSError **)error;
...
- (NSDictionary *)updateTemplateWithTemplateId:(long long)templateId classPK:(long long)classPK nameMap:(NSDictionary *)nameMap descriptionMap:(NSDictionary *)descriptionMap type:(NSString *)type mode:(NSString *)mode language:(NSString *)language script:(NSString *)script cacheable:(BOOL)cacheable serviceContext:(NSDictionary *)serviceContext error:(NSError **)error;
