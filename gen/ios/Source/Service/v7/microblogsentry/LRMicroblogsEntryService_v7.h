...
- (NSDictionary *)addMicroblogsEntryWithUserId:(long long)userId content:(NSString *)content type:(int)type parentMicroblogsEntryId:(long long)parentMicroblogsEntryId socialRelationType:(int)socialRelationType serviceContext:(NSDictionary *)serviceContext error:(NSError **)error;
