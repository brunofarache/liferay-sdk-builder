package com.liferay.mobile.sdk.v7.mbcategory;
...
public interface MBCategoryService {
  ...
  @Path("/get-categories")
  Call<JSONArray> getCategories(@Param(name = "groupId") long groupId, @Param(name = "excludedCategoryId") long excludedCategoryId, @Param(name = "parentCategoryId") long parentCategoryId, @Param(name = "status") int status, @Param(name = "start") int start, @Param(name = "end") int end);

  @Path("/get-categories")
  Call<JSONArray> getCategories(@Param(name = "groupId") long groupId, @Param(name = "excludedCategoryIds") JSONArray excludedCategoryIds, @Param(name = "parentCategoryIds") JSONArray parentCategoryIds, @Param(name = "status") int status, @Param(name = "start") int start, @Param(name = "end") int end);

  @Path("/get-categories-and-threads")
  Call<JSONArray> getCategoriesAndThreads(@Param(name = "groupId") long groupId, @Param(name = "categoryId") long categoryId);

  @Path("/get-categories-and-threads")
  Call<JSONArray> getCategoriesAndThreads(@Param(name = "groupId") long groupId, @Param(name = "categoryId") long categoryId, @Param(name = "status") int status);

  @Path("/get-categories-and-threads")
  Call<JSONArray> getCategoriesAndThreads(@Param(name = "groupId") long groupId, @Param(name = "categoryId") long categoryId, @Param(name = "status") int status, @Param(name = "start") int start, @Param(name = "end") int end);

  @Path("/get-categories-and-threads-count")
  Call<Integer> getCategoriesAndThreadsCount(@Param(name = "groupId") long groupId, @Param(name = "categoryId") long categoryId);

  @Path("/get-categories-and-threads-count")
  Call<Integer> getCategoriesAndThreadsCount(@Param(name = "groupId") long groupId, @Param(name = "categoryId") long categoryId, @Param(name = "status") int status);
  ...
  @Path("/get-categories-count")
  Call<Integer> getCategoriesCount(@Param(name = "groupId") long groupId, @Param(name = "excludedCategoryId") long excludedCategoryId, @Param(name = "parentCategoryId") long parentCategoryId, @Param(name = "status") int status);

  @Path("/get-categories-count")
  Call<Integer> getCategoriesCount(@Param(name = "groupId") long groupId, @Param(name = "excludedCategoryIds") JSONArray excludedCategoryIds, @Param(name = "parentCategoryIds") JSONArray parentCategoryIds, @Param(name = "status") int status);
