...
public interface LayoutService {
  ...
  @Path("/add-layout")
  Call<JSONObject> addLayout(@Param(name = "groupId") long groupId, @Param(name = "privateLayout") boolean privateLayout, @Param(name = "parentLayoutId") long parentLayoutId, @Param(name = "localeNamesMap") JSONObject localeNamesMap, @Param(name = "localeTitlesMap") JSONObject localeTitlesMap, @Param(name = "descriptionMap") JSONObject descriptionMap, @Param(name = "keywordsMap") JSONObject keywordsMap, @Param(name = "robotsMap") JSONObject robotsMap, @Param(name = "type") String type, @Param(name = "typeSettings") String typeSettings, @Param(name = "hidden") boolean hidden, @Param(name = "friendlyURLMap") JSONObject friendlyURLMap, @Param(name = "serviceContext", className = "com.liferay.portal.kernel.service.ServiceContext") JSONObject serviceContext);

  @Path("/delete-layout")
  Call<Response> deleteLayout(@Param(name = "plid") long plid, @Param(name = "serviceContext", className = "com.liferay.portal.kernel.service.ServiceContext") JSONObject serviceContext);

  @Path("/delete-layout")
  Call<Response> deleteLayout(@Param(name = "groupId") long groupId, @Param(name = "privateLayout") boolean privateLayout, @Param(name = "layoutId") long layoutId, @Param(name = "serviceContext", className = "com.liferay.portal.kernel.service.ServiceContext") JSONObject serviceContext);
  ...
  @Path("/export-layouts")
  Call<JSONArray> exportLayouts(@Param(name = "groupId") long groupId, @Param(name = "privateLayout") boolean privateLayout, @Param(name = "parameterMap") JSONObject parameterMap, @Param(name = "startDate") long startDate, @Param(name = "endDate") long endDate);

  @Path("/export-layouts")
  Call<JSONArray> exportLayouts(@Param(name = "groupId") long groupId, @Param(name = "privateLayout") boolean privateLayout, @Param(name = "layoutIds") JSONArray layoutIds, @Param(name = "parameterMap") JSONObject parameterMap, @Param(name = "startDate") long startDate, @Param(name = "endDate") long endDate);
  ...
  @Path("/export-layouts-as-file")
  Call<JSONObject> exportLayoutsAsFile(@Param(name = "groupId") long groupId, @Param(name = "privateLayout") boolean privateLayout, @Param(name = "layoutIds") JSONArray layoutIds, @Param(name = "parameterMap") JSONObject parameterMap, @Param(name = "startDate") long startDate, @Param(name = "endDate") long endDate);
  ...
  @Path("/export-layouts-as-file-in-background")
  Call<Long> exportLayoutsAsFileInBackground(@Param(name = "taskName") String taskName, @Param(name = "groupId") long groupId, @Param(name = "privateLayout") boolean privateLayout, @Param(name = "layoutIds") JSONArray layoutIds, @Param(name = "parameterMap") JSONObject parameterMap, @Param(name = "startDate") long startDate, @Param(name = "endDate") long endDate);

  @Path("/export-layouts-as-file-in-background")
  Call<Long> exportLayoutsAsFileInBackground(@Param(name = "taskName") String taskName, @Param(name = "groupId") long groupId, @Param(name = "privateLayout") boolean privateLayout, @Param(name = "layoutIds") JSONArray layoutIds, @Param(name = "parameterMap") JSONObject parameterMap, @Param(name = "startDate") long startDate, @Param(name = "endDate") long endDate, @Param(name = "fileName") String fileName);

  @Path("/export-portlet-info")
  Call<JSONArray> exportPortletInfo(@Param(name = "companyId") long companyId, @Param(name = "portletId") String portletId, @Param(name = "parameterMap") JSONObject parameterMap, @Param(name = "startDate") long startDate, @Param(name = "endDate") long endDate);

  @Path("/export-portlet-info")
  Call<JSONArray> exportPortletInfo(@Param(name = "plid") long plid, @Param(name = "groupId") long groupId, @Param(name = "portletId") String portletId, @Param(name = "parameterMap") JSONObject parameterMap, @Param(name = "startDate") long startDate, @Param(name = "endDate") long endDate);
  ...
  @Path("/export-portlet-info-as-file")
  Call<JSONObject> exportPortletInfoAsFile(@Param(name = "portletId") String portletId, @Param(name = "parameterMap") JSONObject parameterMap, @Param(name = "startDate") long startDate, @Param(name = "endDate") long endDate);

  @Path("/export-portlet-info-as-file")
  Call<JSONObject> exportPortletInfoAsFile(@Param(name = "plid") long plid, @Param(name = "groupId") long groupId, @Param(name = "portletId") String portletId, @Param(name = "parameterMap") JSONObject parameterMap, @Param(name = "startDate") long startDate, @Param(name = "endDate") long endDate);

  @Path("/export-portlet-info-as-file-in-background")
  Call<Long> exportPortletInfoAsFileInBackground(@Param(name = "taskName") String taskName, @Param(name = "portletId") String portletId, @Param(name = "parameterMap") JSONObject parameterMap, @Param(name = "startDate") long startDate, @Param(name = "endDate") long endDate, @Param(name = "fileName") String fileName);

  @Path("/export-portlet-info-as-file-in-background")
  Call<Long> exportPortletInfoAsFileInBackground(@Param(name = "taskName") String taskName, @Param(name = "plid") long plid, @Param(name = "groupId") long groupId, @Param(name = "portletId") String portletId, @Param(name = "parameterMap") JSONObject parameterMap, @Param(name = "startDate") long startDate, @Param(name = "endDate") long endDate, @Param(name = "fileName") String fileName);
  ...
  @Path("/import-layouts")
  Call<Response> importLayouts(@Param(name = "groupId") long groupId, @Param(name = "privateLayout") boolean privateLayout, @Param(name = "parameterMap") JSONObject parameterMap, @Param(name = "bytes") byte[] bytes);

  @Path(
      value = "/import-layouts",
      contentType = ContentType.MULTIPART
  )
  Call<Response> importLayouts(@Param(name = "groupId") long groupId, @Param(name = "privateLayout") boolean privateLayout, @Param(name = "parameterMap") JSONObject parameterMap, @Param(name = "file") UploadData file);

  @Path(
      value = "/import-layouts-in-background",
      contentType = ContentType.MULTIPART
  )
  Call<Long> importLayoutsInBackground(@Param(name = "taskName") String taskName, @Param(name = "groupId") long groupId, @Param(name = "privateLayout") boolean privateLayout, @Param(name = "parameterMap") JSONObject parameterMap, @Param(name = "file") UploadData file);
  ...
  Call<Response> importPortletInfo(@Param(name = "portletId") String portletId, @Param(name = "parameterMap") JSONObject parameterMap, @Param(name = "file") UploadData file);

  @Path(
      value = "/import-portlet-info",
      contentType = ContentType.MULTIPART
  )
  Call<Response> importPortletInfo(@Param(name = "plid") long plid, @Param(name = "groupId") long groupId, @Param(name = "portletId") String portletId, @Param(name = "parameterMap") JSONObject parameterMap, @Param(name = "file") UploadData file);

  @Path(
      value = "/import-portlet-info-in-background",
      contentType = ContentType.MULTIPART
  )
  Call<Response> importPortletInfoInBackground(@Param(name = "taskName") String taskName, @Param(name = "portletId") String portletId, @Param(name = "parameterMap") JSONObject parameterMap, @Param(name = "file") UploadData file);

  @Path(
      value = "/import-portlet-info-in-background",
      contentType = ContentType.MULTIPART
  )
  Call<Long> importPortletInfoInBackground(@Param(name = "taskName") String taskName, @Param(name = "plid") long plid, @Param(name = "groupId") long groupId, @Param(name = "portletId") String portletId, @Param(name = "parameterMap") JSONObject parameterMap, @Param(name = "file") UploadData file);

  @Path("/schedule-publish-to-live")
  Call<Response> schedulePublishToLive(@Param(name = "sourceGroupId") long sourceGroupId, @Param(name = "targetGroupId") long targetGroupId, @Param(name = "privateLayout") boolean privateLayout, @Param(name = "layoutIds") JSONArray layoutIds, @Param(name = "parameterMap") JSONObject parameterMap, @Param(name = "groupName") String groupName, @Param(name = "cronText") String cronText, @Param(name = "schedulerStartDate") long schedulerStartDate, @Param(name = "schedulerEndDate") long schedulerEndDate, @Param(name = "description") String description);

  @Path("/schedule-publish-to-live")
  Call<Response> schedulePublishToLive(@Param(name = "sourceGroupId") long sourceGroupId, @Param(name = "targetGroupId") long targetGroupId, @Param(name = "privateLayout") boolean privateLayout, @Param(name = "layoutIdMap") JSONObject layoutIdMap, @Param(name = "parameterMap") JSONObject parameterMap, @Param(name = "scope") String scope, @Param(name = "startDate") long startDate, @Param(name = "endDate") long endDate, @Param(name = "groupName") String groupName, @Param(name = "cronText") String cronText, @Param(name = "schedulerStartDate") long schedulerStartDate, @Param(name = "schedulerEndDate") long schedulerEndDate, @Param(name = "description") String description);

  @Path("/schedule-publish-to-live")
  Call<Response> schedulePublishToLive(@Param(name = "sourceGroupId") long sourceGroupId, @Param(name = "targetGroupId") long targetGroupId, @Param(name = "privateLayout") boolean privateLayout, @Param(name = "layoutIds") JSONArray layoutIds, @Param(name = "parameterMap") JSONObject parameterMap, @Param(name = "scope") String scope, @Param(name = "startDate") long startDate, @Param(name = "endDate") long endDate, @Param(name = "groupName") String groupName, @Param(name = "cronText") String cronText, @Param(name = "schedulerStartDate") long schedulerStartDate, @Param(name = "schedulerEndDate") long schedulerEndDate, @Param(name = "description") String description);

  @Path("/schedule-publish-to-remote")
  Call<Response> schedulePublishToRemote(@Param(name = "sourceGroupId") long sourceGroupId, @Param(name = "privateLayout") boolean privateLayout, @Param(name = "layoutIdMap") JSONObject layoutIdMap, @Param(name = "parameterMap") JSONObject parameterMap, @Param(name = "remoteAddress") String remoteAddress, @Param(name = "remotePort") int remotePort, @Param(name = "remotePathContext") String remotePathContext, @Param(name = "secureConnection") boolean secureConnection, @Param(name = "remoteGroupId") long remoteGroupId, @Param(name = "remotePrivateLayout") boolean remotePrivateLayout, @Param(name = "startDate") long startDate, @Param(name = "endDate") long endDate, @Param(name = "groupName") String groupName, @Param(name = "cronText") String cronText, @Param(name = "schedulerStartDate") long schedulerStartDate, @Param(name = "schedulerEndDate") long schedulerEndDate, @Param(name = "description") String description);

  @Path("/set-layouts")
  Call<Response> setLayouts(@Param(name = "groupId") long groupId, @Param(name = "privateLayout") boolean privateLayout, @Param(name = "parentLayoutId") long parentLayoutId, @Param(name = "layoutIds") JSONArray layoutIds, @Param(name = "serviceContext", className = "com.liferay.portal.kernel.service.ServiceContext") JSONObject serviceContext);
  ...
  @Path("/update-layout")
  Call<JSONObject> updateLayout(@Param(name = "groupId") long groupId, @Param(name = "privateLayout") boolean privateLayout, @Param(name = "layoutId") long layoutId, @Param(name = "parentLayoutId") long parentLayoutId, @Param(name = "localeNamesMap") JSONObject localeNamesMap, @Param(name = "localeTitlesMap") JSONObject localeTitlesMap, @Param(name = "descriptionMap") JSONObject descriptionMap, @Param(name = "keywordsMap") JSONObject keywordsMap, @Param(name = "robotsMap") JSONObject robotsMap, @Param(name = "type") String type, @Param(name = "hidden") boolean hidden, @Param(name = "friendlyURLMap") JSONObject friendlyURLMap, @Param(name = "iconImage") boolean iconImage, @Param(name = "iconBytes") byte[] iconBytes, @Param(name = "serviceContext", className = "com.liferay.portal.kernel.service.ServiceContext") JSONObject serviceContext);
  ...
  Call<JSONObject> validateImportLayoutsFile(@Param(name = "groupId") long groupId, @Param(name = "privateLayout") boolean privateLayout, @Param(name = "parameterMap") JSONObject parameterMap, @Param(name = "file") UploadData file);
  ...
  Call<JSONObject> validateImportPortletInfo(@Param(name = "plid") long plid, @Param(name = "groupId") long groupId, @Param(name = "portletId") String portletId, @Param(name = "parameterMap") JSONObject parameterMap, @Param(name = "file") UploadData file);
}
