...
- (NSArray *)getStructureVersionsWithStructureId:(long long)structureId start:(int)start end:(int)end orderByComparator:(NSDictionary *)orderByComparator error:(NSError **)error {
	NSMutableDictionary *_params = [NSMutableDictionary dictionaryWithDictionary:@{
		@"structureId": @(structureId),
		@"start": @(start),
		@"end": @(end),
